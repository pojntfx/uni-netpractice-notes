...
TODO: Add result (see screenshots and pictures from Felix's phone (Misswire) and PDF: We first tried to connect it differently, so there are multiple versions)
...
TODO: Add result (see pictures from Felix's phone (Pass, but with blinking C) and PDF)
...
TODO: Add result (see pictures from Felix's phone (Open, but with blinking 3,4,5,6) and PDF)
